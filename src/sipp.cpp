...
//     {"trace_timeout", "Displays call ids for calls with timeouts in <scenario file name>_<pid>_timeout.log", SIPP_OPTION_SETFLAG, &useTimeoutf, 1},
    ...
    {"mqtt_log_topic", "Set the MQTT topic for publishing log messages. Default is '/sipp/log'.", SIPP_OPTION_STRING, &mqtt_log_topic, 1},
//    {"mqtt_warning_topic", "Set the MQTT topic for publishing warning messages. Default is '/sipp/warning'.", SIPP_OPTION_STRING, &mqtt_warning_topic, 1},
    ...
    {"mqtt_message_topic", NULL, SIPP_OPTION_NEED_MQTT, NULL, 1},
    {"mqtt_log_topic", NULL, SIPP_OPTION_NEED_MQTT, NULL, 1},
//    {"mqtt_warning_topic", NULL, SIPP_OPTION_NEED_MQTT, NULL, 1},
